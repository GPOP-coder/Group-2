...
- **Plaud** — AI voice recorder; Pete considering a purchase (flagged 8/6/26, prompted by seeing Bron Walis use one to record the 8/6/26 Mohonk Basic Training class). Would directly address the "lost breakthrough problem" — live sessions currently rely on Pete's own after-the-fact Voice Memo brain dump, which can miss detail. **Researched 8/8/26 — under consideration, no model/decision locked in.** Two candidates: Plaud Note ($159, credit-card form factor, up to 30 hrs recording, also handles phone calls, 600 free min/month) vs. Plaud NotePin/NotePin S ($159/$179, wearable clip/pin/lanyard/wristband, up to 20 hrs, in-person only, 300 free min/month). Both need a paid plan beyond free minutes (Pro tier or ~$240/yr Unlimited). Leaning NotePin S for hands-free fit with onsite training/walkthroughs, but not decided. **Interim decision 8/9/26 (superseded 8/13/26 — see below):** a separate session logged "buy new, not open box" reasoning that open box carried account/subscription reassignment risk not worth taking on a primary capture device. **8/13/26 — that reassignment-risk concern was directly disproven.** Plaud Support chat confirmed devices are account-bound, not unit-locked: prior owner unbinds from their account (Plaud app → Device page → unbind/remove), then Pete binds it fresh to his own account. No promo/minutes are lost by buying used or open box — a newly-bound device (new, open box, or used) gets the same free Starter Plan (300 transcription min/month) regardless of unit history. This removes the basis for the 8/9/26 "buy new" call; decision reopened across new / open box / used. **Specific eBay listing identified (item #327307181434):** Note Pro, Black, 64GB, MPN PN0300 (confirmed genuine — FCC ID 2BQL2-PN0300, IC ID 34217-PN0300 both match), S/N 8810B30251xx. eBay's official condition grade is **"New – Open Box"** ("excellent, new condition with no functional defects... may have been used for testing or demo purposes... includes accessories found with original product") — resolves the earlier New-vs-used ambiguity from the box photo; this is genuinely the open-box tier, not a private used sale. **Price: $124.99 (Buy It Now).** **Seller confirmed 8/13/26 via eBay chat:** unit was previously registered/bound to a Plaud account, but seller has already unbound it — clean handoff, Pete just creates his own account and binds fresh per the Plaud Support process above. **Seller: "pennygold"** — 99.9% positive feedback, 1.2K items sold, eBay member since Dec 2007, usually responds within 24 hrs — reputable/established seller, low risk. At $124.99 vs. $159 new, this now looks like the strongest option researched so far — no reassignment risk (disproven above), already unbound, reputable seller, real savings. **Watch for (from 8/9/26 research, still relevant if buying new instead):** Plaud site promos/affiliate codes (10–15%), Amazon price drops, Black Friday (20–25%).
