...
- **Makeready (part of Rockbridge)** — 3 properties total (Moran, Heathman, and Greenleigh — see below); Pete as trainer. Steve Carrell owns config; John Grech owns post-config; Taylor Walton owns post go-live follow-up.
  ...
  - **Heathman, Portland** — Tentative: **Oct 19–22, 2026** (Mon–Thu), per Ralph's resource calendar screenshot 8/14/26 — corrects the earlier Oct 12–15 estimate, and lands the week after DT Sunrise (Oct 12–14), not the same week.
...
- **Sep 7, 2026 (week of)** — Marriott Del Mar, San Diego CA — HMAlpha onsite training — ✅ week confirmed 9/2/26 directly with Taylor Walton (configurer). Property contacts: Mark Ziomek (GM, engaged), Sandra Academia (DOF — actual key user who'll run the system), Valeria Ruvalcaba (HR, newer to system). **Outbound flight: Monday 9/7. Return flight booked (9/2/26):** Southwest #3440, confirmation **BEIJHG**, Fri 9/11, SAN→OMA nonstop, departs 6:45 PM arrives 11:50 PM, seat 08A (Preferred), $446.40 total ($392.40 Visa ••••2674 + $54.00 flight credit) — a late-day departure that leaves a full Friday for meetings through early afternoon before heading to the airport. DoubleTree San Diego Del Mar (same San Diego pair) has been reassigned to John Grech as trainer (config Oct 5, training Oct 19) — Pete no longer involved there, learned informally on this same call. Full detail: `pws/clients/hmalpha/marriott-del-mar/2026-09-02_taylor-walton-prep-call.md`.
...
- **Sep 20–26, 2026** — Disney Cruise, Port Canaveral FL — **personal** (Kim); blocked with Ralph Varble. **Bahamas stop: Wednesday, Sep 23, 2026** — current plan has Pete back onboard by 5:30 PM. Ship is the **Disney Destiny**; a third-party port-schedule app (sent by Jessica) shows Nassau call times 8:00 AM–5:30 PM that day — matches Pete's 5:30 PM plan, but **treat as tentative** (unofficial source, not Disney's own itinerary).
