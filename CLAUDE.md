...
- **🔴 URGENT open ticket UNIFOCUS-259575** — Emre filed "Unable to upload KBI" 8/14/26 10:30am, marked urgent, no error detail included yet. Risk: could block Emre's Monday 8/17 payroll budget start if unresolved — get the actual error from Emre and check status before Monday.
