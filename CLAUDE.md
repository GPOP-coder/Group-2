...
- **🔴 Rosewood Butler standard — hard config deadline Wednesday, August 19, 2026.** Base manning breakpoint (9 FTE floor, scaling to ~44-45 FTE at full house) received from Emre 8/12/26; mid-curve breakpoints still need to be built in Unifocus Standard Set "Budget Standards 2027" before the 8/19 deadline. Feeds Rosewood's first 2027 payroll budget submission (due end of August 2026). Full detail: `pws/clients/baha-mar/2026-08-12_emre-butler-base-manning-breakpoint.md`.
