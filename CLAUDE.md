...
- **Plaud** — AI voice recorder; Pete considering a purchase (flagged 8/6/26, prompted by seeing Bron Walis use one to record the 8/6/26 Mohonk Basic Training class). Would directly address the "lost breakthrough problem" — live sessions currently rely on Pete's own after-the-fact Voice Memo brain dump, which can miss detail. **Researched 8/8/26 — under consideration, no model/decision locked in.** Two candidates: Plaud Note ($159, credit-card form factor, up to 30 hrs recording, also handles phone calls, 600 free min/month) vs. Plaud NotePin/NotePin S ($159/$179, wearable clip/pin/lanyard/wristband, up to 20 hrs, in-person only, 300 free min/month). Both need a paid plan beyond free minutes (Pro tier or ~$240/yr Unlimited). Leaning NotePin S for hands-free fit with onsite training/walkthroughs, but not decided. **8/13/26 — third option surfaced: a used Plaud Note Pro offered to Pete.** Confirmed via Plaud Support chat: device is account-bound, not unit-locked — prior owner unbinds it from their account (Plaud app → Device page → unbind/remove), then Pete creates his own account and binds the device fresh. No promo/minutes are lost or non-transferable by buying used — a newly-bound device (new or used) gets the same free Starter Plan (300 transcription min/month) regardless of unit history. This removes the main "buy new" advantage Pete was weighing, and he flagged it may shift him toward taking the used unit instead of buying new. **Open Box also flagged 8/13/26 as a good middle option** (presumably retailer/Plaud open-box stock — cheaper than new, likely less wear than a private used unit, same account-binding process would apply). Decision still open across new / open box / used. **8/13/26 — specific eBay listing identified (item #327307181434):** Note Pro, Black, 64GB, MPN PN0300 (confirmed genuine — FCC ID 2BQL2-PN0300, IC ID 34217-PN0300 both match), S/N 8810B30251xx. eBay's official condition grade is **"New – Open Box"** ("excellent, new condition with no functional defects... may have been used for testing or demo purposes... includes accessories found with original product") — resolves the earlier New-vs-used ambiguity from the box photo; this is genuinely the "open box" tier Pete flagged as a good middle option, not a private used sale. **Still worth confirming with the seller** whether the unit was ever registered/bound to a Plaud account during testing/demo — if yes, still needs the unbind process (prior account → Device page → unbind, then Pete binds fresh per Plaud Support); if never bound, it's a clean setup like new. Price not yet captured. **Seller: "pennygold"** — 99.9% positive feedback, 1.2K items sold, eBay member since Dec 2007, usually responds within 24 hrs — reputable/established seller, low risk.
