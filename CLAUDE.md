...
- **Plaud** — AI voice recorder; flagged 8/6/26 after seeing Bron Walis use one at Mohonk. Would directly address the "lost breakthrough problem" — live sessions currently rely on Pete's own after-the-fact Voice Memo brain dump, which can miss detail. **Researched 8/8/26.** Two candidates: Plaud Note ($159, credit-card form factor, up to 30 hrs recording, also handles phone calls, 600 free min/month) vs. Plaud NotePin/NotePin S ($159/$179, wearable clip/pin/lanyard/wristband, up to 20 hrs, in-person only, 300 free min/month). Both need a paid plan beyond free minutes (Pro tier or ~$240/yr Unlimited). Leaning NotePin S for hands-free fit with onsite training/walkthroughs, but not decided. **Decision (8/9/26):** Buy new, not open box — open box (~$140) creates account/subscription reassignment risk not worth taking on a primary capture device; open box viable as future backup once reassignment process confirmed. Watch for: Plaud site promos/affiliate codes (10–15%), Amazon price drops, Black Friday (20–25%). Purchase pending.
