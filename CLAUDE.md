...
- [ ] **🔴 OVERDUE: Send Westin La Paloma (8/17–21) training kickoff invite** — per Pete's own ~2-week-out rule, should have gone out by 8/3; flagged on 8/5/26 CI mapping call with Nicole Mendez. **Draft ready** at `pws/clients/hmalpha/westin-la-paloma/2026-08-07_training-intro-email-draft.md` — needs session day/times, sign-up deadline, and PDF attachments before sending; plan is to send while traveling 8/7/26.
