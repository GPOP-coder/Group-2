...
- **Sep 7, 2026 (week of)** — Marriott Del Mar, San Diego CA — HMAlpha onsite training — ✅ week confirmed 9/2/26 directly with Taylor Walton (configurer). Property contacts: Mark Ziomek (GM, engaged), Sandra Academia (DOF — actual key user who'll run the system), Valeria Ruvalcaba (HR, newer to system). **Outbound flight: Monday 9/7. Return flight not yet booked** — offering the property a full Friday onsite with Saturday departure, still shopping flights. DoubleTree San Diego Del Mar (same San Diego pair) has been reassigned to John Grech as trainer (config Oct 5, training Oct 19) — Pete no longer involved there, learned informally on this same call. Full detail: `pws/clients/hmalpha/marriott-del-mar/2026-09-02_taylor-walton-prep-call.md`.
