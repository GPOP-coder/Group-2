"""
Build The Moran, Houston Trip Receipt Packet.
...
PHOTOS = Path(r"C:\Users\peter\Documents\Group-2\travel\trips\receipts")
STATIONARY = Path(r"C:\Users\peter\Documents\Group-2\pws\billing\templates\unifocus-letterhead-stationary.pdf")
OUT_DIR = Path(r"C:\Users\peter\OneDrive\Documents\Platinum Workforce Strategies\Unifocus Contractor\2026-09-04 MR Moran")
OUTPUT = OUT_DIR / "2026-08-30_2026-09-04-moran-receipt-packet.pdf"

# Ordered source list - matches the ER's chronological line order.
# ("digital", dir, filename) -> insert all pages as-is
# ("physical", dir, filename, rotation_degrees) -> composite onto stationary
SOURCES = [
    ("digital", ARCHIVE, "2026-08-30 Southwest Trip Confirmation BUKKAA Moran Houston.pdf"),
    ("digital", ARCHIVE, "2026-08-30 Uber HOU Airport to Moran Houston.pdf"),
    ("physical", PHOTOS, "2026-08-30 Seasons 52 Houston Dinner.jpg", -3),
    ("physical", PHOTOS, "2026-08-31 bellagreen Houston Lunch.jpg", 4),
    ("physical", PHOTOS, "2026-09-01 The Board Room Houston Lunch.jpg", -2),
    ("digital", ARCHIVE, "2026-09-04 Uber Moran Houston to HOU Airport.pdf"),
    ("digital", ARCHIVE, "2026-09-04 Southwest Trip Confirmation BUGYTC Moran Houston.pdf"),
]

# Letterhead has a header logo in the top ~15% and a footer band in the
# bottom ~13% (confirmed on the Mohonk build) - receipts must stay within
# the safe zone between them, not the full page.
