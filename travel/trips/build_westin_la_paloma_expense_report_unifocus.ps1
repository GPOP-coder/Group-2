# Build Westin La Paloma Trip Expense Report - Unifocus ER Template format
# HMAlpha Onsite Admin/Manager Training — August 16-21, 2026
...
$outputPath = "C:\Users\peter\Documents\Group-2\travel\trips\2026-08-16_2026-08-21_westin-la-paloma-expense-report.xlsx"
...
$s1.Cells.Item(2,2).Value2 = "8/16/2026"; $s1.Cells.Item(2,2).Interior.Color = $yellow; $s1.Cells.Item(2,2).NumberFormat = "m/d/yyyy"
$s1.Cells.Item(2,4).Value2 = "End Date:"; $s1.Cells.Item(2,4).Font.Bold = $true
$s1.Cells.Item(2,5).Value2 = "8/21/2026"; $s1.Cells.Item(2,5).Interior.Color = $yellow; $s1.Cells.Item(2,5).NumberFormat = "m/d/yyyy"
...
$notes = @(
    ...
    "Billable/UF: enter the client name (HM Alpha - Onsite Training Westin La Paloma), or UF if not client-billable.",
    ...
    "",
    "WESTIN LA PALOMA-SPECIFIC NOTES:",
    "- Hotel comped by the property (confirmation #1488816: room, tax, resort charge, parking, F&B no alcohol) - not on this ER.",
    "- No OMA-side ground transport - Kim picked Pete up on return, no Uber/taxi expense either direction at OMA.",
    "- Source: travel/trips/2026-08-16_2026-08-21_westin-la-paloma-receipt-log.md",
    "",
    "All receipts archived to Personal Finance/Receipts/2026/ - ready to submit to Ralph Varble."
)
$row = 1
foreach ($n in $notes) {
