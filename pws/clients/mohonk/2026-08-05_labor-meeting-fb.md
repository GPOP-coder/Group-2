...
- **Beverage:** 8% under. **Confirmed live by Patrice: he personally rebuilt Beverage as a consolidated department that same morning to match ADP's structure** ("I unscattered it this morning") — previously scattered across other departments. This is already reflected correctly in this report. **This directly completes the beverage-restructuring item already tracked in kb.md's Active Issues** (originally requested during the 8/3 Admin Training session) — now done, and done by Patrice himself, not Pete.
...
- Patrice asked directly: can he see **pay**, not just hours, on these reports? Currently he only sees hours.
