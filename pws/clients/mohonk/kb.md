...
| [UNIFOCUS-252999](https://ufjira.atlassian.net/browse/UNIFOCUS-252999) | Standard hours not generating Thursday–Sunday, recurring weekly | 🟡 Fix implemented 8/6/26 (Bron added a Tuesday 1AM extra interface transfer), validation pending over a live cycle — Critical priority, root cause confirmed 7/24/26 |
...
**Status:** 🟡 Fix implemented 8/6/26, validation pending — investigated 7/20/26 with Susanna Briggs; escalated to engineering (Jeremiah Lay, Mrigen Pradhan) post-call; root cause confirmed 7/24/26; Bron implemented a concrete interface-timing fix 8/6/26 (see below) — not yet confirmed working over a full cycle
