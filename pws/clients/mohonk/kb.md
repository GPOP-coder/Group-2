...
- [ ] **Resolve the Wednesday labor-meeting timeline compression problem** — flagged directly by CEO Tom Smiley 8/5/26: either push the forecast → Generate Projected Hours → schedule-build pipeline earlier (Pete's preference: target Monday, currently doesn't run until overnight Mon/Tue), or move the Rooms labor meeting from Wednesday to Thursday. Directly supersedes/reinforces the existing "New timeline" rebuild item above — Tom personally confirmed the current timeline is JPEG-only with no source file. **Target set 8/7/26 (status report draft): aim for a property-wide schedule publish by Thursday EOD**, regardless of which of the two fix directions above is ultimately chosen. See [2026-08-05_labor-meeting-rooms-ceo-session.md](2026-08-05_labor-meeting-rooms-ceo-session.md#4-weekly-projected-schedule-report--the-timeline-compression-problem).
...
- [ ] **Build banquet culinary labor standards — none currently exist.** From Pete's recall of the (unrecorded) 8/6/26 Kitchen meeting — a real gap, future-visit work.
- [ ] **Fix Culinary Extern ADP job-coding** — hours aren't landing on the correct jobs; either push hours to the actual job worked, or use op codes to bundle the reporting instead. From the same 8/6/26 Kitchen meeting recall — future-visit work.
- [ ] **🔴 "Paula's" missing overnight Front Desk hours** — real, unresolved gap (clocks in/paid correctly in ADP, never shows in Unifocus); Casey Dow already tried and gave up. New lead found live 8/6/26: her ADP Pay Code shows "Night Shift" vs. Artem's "Regular," pointing to an unmapped ADP Pay Code in the Actual Hours interface between ADP and UF — either UF never mapped "Night Shift" as worked hours, or Paula is mis-coded in ADP and should match the other overnight agents' coding. Stacy Zappone to check ADP and report back which. See [2026-08-06_front-desk-help-stacy-zappone.md](2026-08-06_front-desk-help-stacy-zappone.md#3--real-open-issue-found-paulas-overnight-hours-missing-from-unifocusreporting).
...
| **Thu 1:00–2:30 PM** (new, confirmed via calendar 8/6/26 — not in the original 7/24 draft) | **Labor Standard Meeting — Kitchen. Not recorded** — no transcript exists. **Pete's own recall, captured 8/6/26 EOD (partial — "I have some notes," more may follow):** "Kitchen was pretty straightforward." Two major takeaways: **(1) no standards exist for banquet culinary workload**; **(2) Culinary Extern hours aren't being coded in ADP to the correct jobs** — needs either pushing hours out to the actual jobs worked at the time, or using op codes to bundle the labor reporting instead. **Noted as future-visit work, not resolved this trip.** | Bron Walis, Patrice Huart, James Palmeri, Lou Petruzzelli, Pete Castellano |
