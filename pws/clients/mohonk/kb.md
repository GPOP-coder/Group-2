...
| Alex Nee | Recreation | — (⚠️ possibly the same person as Alex Sherwood below — this entry only ever appeared in scheduling-logistics notes, never a substantive conversation; needs confirmation) |
| Alex Sherwood | Runs standards across Front Office, Guest Services, Recreation, Housekeeping, Laundry, Safety/Security, and Gatehouse (broad Rooms Division-style scope) | — (new 8/5/26, see [2026-08-05_rooms-division-standards-review.md](2026-08-05_rooms-division-standards-review.md)) |
