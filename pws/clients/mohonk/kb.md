...
- [ ] **Define whether schedule publishing requires second-level approval** and configure system settings accordingly — open question from the 8/3/26 PM session, not decided.
...
- [ ] **Map the ADP eTime migration timeline explicitly** to sequence any further Unifocus↔ADP interface work and avoid rework — the retirement-within-1–2-years fact is already cross-referenced against the $4,000 punch-to-schedule decision above, but a concrete migration timeline/map itself hasn't been produced.
