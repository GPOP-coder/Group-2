...
- [ ] **Start tracking/quantifying trainer hours separately as an explainable-variance input** (not to remove them from the server standard — confirmed 8/16/26 they stay counted, trainers are doing real work) — Pete's own refinement, same principle as the 8/3 PM session's bleach-training example: a documented hours figure turns "we had training" into a real, quantified explanation at the labor meeting rather than a vague excuse. No tracking mechanism set up yet.
