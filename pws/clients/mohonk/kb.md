...
- [ ] **Standardize new Unifocus user creation by copying an existing template user profile**, and review/clean up security-group settings — recommended 8/3/26 PM session in response to "weird" permission-enforcement issues traced to per-user overrides. Not started.
