...
- [ ] **Discuss Beverage department structure with James; obtain the ADP configuration report and full job code list** to align Unifocus job codes and GL/P&L reporting — flagged 8/3/26 PM session, ties into the broader Beverage restructuring work already underway elsewhere in this file. Also open: whether adding more GL-level beverage detail passes a "materiality test."
