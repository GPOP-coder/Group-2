...
- [x] **Arterra Bartender confirmed working, update 9/12/26** — beverage-revenue-based (Bar Revenue KBI), actuals flowing correctly for the week of 9/5–9/11/26. Distinct from the still-open Banquet Bartender gap (event/BEO-driven bar staffing) — see below.
...
- [ ] Build a Banquet Bartender job code and labor standard — doesn't exist at all currently; no event type reliably triggers banquet bar labor. (Distinct from Arterra's outlet Bartender, confirmed working 9/12/26.)
