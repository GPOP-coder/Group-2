...
- **Send as PDF** — protocol for all outgoing documents; Taylor sent Pete the Word version so Pete has it editable
- Document versioning chaos acknowledged — multiple slightly different versions floating; need a single master template going forward (same problem that got fixed when Hilton forced uniformity)
- **Tonight:** Pete and Taylor reconnecting on Teams to work through it

---

## Weekly Follow-Up Meetings

- **Structure:** 4 weeks of weekly calls; on the day the property already holds their weekly labor meeting (already identified)
- Taylor sending the proposal email today for Union Station and Westlake — gives property tomorrow to respond if the time doesn't work
- Calendar invites to follow shortly after; days are fixed, time may shift by an hour if needed
- Rationale for fixed day: "The less wiggle room we give them, the better off they're gonna be"
- One-off calls can be set up for department-specific issues (e.g., front desk side meeting); group calls stay inclusive
- Same structure anticipated for Raleigh once John wraps up there
...
- Pete's additions (documented, has a written copy):
  - Forecast mapping
  - KBI mapping — **taught Nicole how to do it herself** ("teach her how to fish")
  - Nicole expressed genuine interest in learning configuration
- Pete's position: "They have to know how to do this — you can't throw your hands up when it's broken or when you want to add a line"
- This will go in the status report to document what was covered beyond the abbreviated list
...
- Taylor: "No rush — towards end of your training. Queue it up. Feed it to me on Teams."
