...
| UNIFOCUS-259575 | Rosewood Baha Mar — Unable to upload KBI | 🔴 Open — filed by Emre 8/14/26 10:30 AM, marked urgent ("please assist as a matter of urgency"). Error message referenced but not included in the ticket-creation email — need the actual screenshot/error text from Emre. **Risk: could block the 2027 payroll budget work Emre plans to start Monday 8/17/26** if a KBI upload is part of that workflow — worth checking urgently. |
