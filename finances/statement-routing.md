...
| Janet's E*TRADE (JLC, individual account #3596-0197) | `Castellano Family Executor\Janet Castellano E*TRADE\` (new folder, created 2026-08-24 per Pete's request) | `YYYY-MM-DD JLC ETRADE Statement.pdf` | Historical/closed account — see the American Century section below for what happened to these assets after Janet passed. Note: one older E*TRADE statement (`ETRADE Q4 Statement 2022_1231.pdf`) already sits in `Probate JLC\` from the estate-administration period — not moved into this new folder, flagged to Pete rather than relocated unbidden. |
| Estate-of-Janet / probate-era correspondence (not an ongoing account) | `Castellano Family Executor\Probate JLC\` (existing folder) | `YYYY-MM-DD JLC [Description].pdf` | For one-off historical documents addressed to "Estate of Janet L. Castellano" rather than an active account — e.g. a 2023 USAA rewards-correction check for a since-closed card (ending 9251, distinct from William's 0149) was filed here as "JLC USAA Estate Rewards Correction," matching this folder's existing content (probate filings, affidavits, the Q4 2022 E*TRADE statement above). |
